...
SCRIPT_NAME = "177_run_oregon_estuary_null_model_validation_v01"
...
ESTUARIES = Path("data/validation/standardized/estuaries_oregon_pmep_v01.gpkg")

OUTPUT_DIR = Path("data/validation/results")

OUTPUT_OBSERVED_CSV = OUTPUT_DIR / "oregon_estuary_observed_validation_metrics_v01.csv"
OUTPUT_NULL_CSV = OUTPUT_DIR / "oregon_estuary_null_model_results_v01.csv"
OUTPUT_COMPARISON_CSV = OUTPUT_DIR / "oregon_estuary_null_model_comparison_v01.csv"
OUTPUT_REPORT_MD = OUTPUT_DIR / "oregon_estuary_null_model_report_v01.md"
...
def write_report(observed, comparison, output_path):
    ...
    lines.append("# Oregon Estuary Null Model Validation Report v01")
    lines.append("")
    lines.append(
        "This report compares observed Oregon RDE transition hotspots "
        "against randomized hotspot placements using PMEP estuary extents."
    )
    lines.append("")
    ...
    lines.append("")
    lines.append(
        "Low Monte Carlo p-values indicate that observed hotspots align with "
        "estuaries more strongly than expected under the spatial null model."
    )
