...
SCRIPT_NAME = "128_compute_oregon_urem_score_v05"
...
OUT_SCORE_GPKG = PROCESSED_DIR / "oregon_urem_score_v05.gpkg"
OUT_SCORE_CSV = PROCESSED_DIR / "oregon_urem_score_v05.csv"

OUT_RANKED_GPKG = PROCESSED_DIR / "oregon_ranked_urem_candidates_v05.gpkg"
OUT_RANKED_CSV = PROCESSED_DIR / "oregon_ranked_urem_candidates_v05.csv"
...
def main():
    ...
    ranked = ranked.sort_values("urem_score_v05_raw", ascending=False).reset_index(drop=True)
