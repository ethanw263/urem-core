...
SCRIPT_NAME = "183_run_oregon_gnis_null_model_validation_v01"
...
GNIS = Path("data/validation/standardized/gnis_named_natural_features_oregon_v01.gpkg")

OUTPUT_DIR = Path("data/validation/results")

OUTPUT_OBSERVED_CSV = OUTPUT_DIR / "oregon_gnis_named_features_observed_validation_metrics_v01.csv"
OUTPUT_NULL_CSV = OUTPUT_DIR / "oregon_gnis_named_features_null_model_results_v01.csv"
OUTPUT_COMPARISON_CSV = OUTPUT_DIR / "oregon_gnis_named_features_null_model_comparison_v01.csv"
OUTPUT_REPORT_MD = OUTPUT_DIR / "oregon_gnis_named_features_null_model_report_v01.md"
...
def write_report(observed, comparison, output_path):
    ...
    lines.append("# Oregon GNIS Named Natural Features Null Model Validation Report v01")
    lines.append("")
    lines.append(
        "This report compares observed Oregon RDE transition hotspots "
        "against randomized hotspot placements using USGS GNIS named natural features."
    )
    lines.append("")
    ...
    lines.append("")
    lines.append(
        "Low Monte Carlo p-values indicate that observed RDE hotspots align with "
        "GNIS named natural features more strongly than expected under randomized "
        "hotspot placement."
    )
