#!/usr/bin/env python3
"""
125_build_oregon_recognition_features_v04.py

Build Oregon Recognition Features v04.

Purpose:
- Count expanded OSM v04 recognition features around each Oregon grid cell.
- Merge Oregon land validity mask.

Inputs:
- data/processed/oregon_coast_grid_v01.gpkg
- data/processed/oregon_osm_recognition_features_v04.gpkg
- data/processed/oregon_land_validity_mask_v01.gpkg

Outputs:
- data/processed/oregon_recognition_features_v04.gpkg
- data/processed/oregon_recognition_features_v04.csv
"""
...
SCRIPT_NAME = "125_build_oregon_recognition_features_v04"

BASE_DIR = Path(__file__).resolve().parents[1]

GRID_PATH = BASE_DIR / "data/processed/oregon_coast_grid_v01.gpkg"
OSM_V04_PATH = BASE_DIR / "data/processed/oregon_osm_recognition_features_v04.gpkg"
LAND_MASK_PATH = BASE_DIR / "data/processed/oregon_land_validity_mask_v01.gpkg"

OUT_GPKG = BASE_DIR / "data/processed/oregon_recognition_features_v04.gpkg"
OUT_CSV = BASE_DIR / "data/processed/oregon_recognition_features_v04.csv"
TEMP_CSV = BASE_DIR / "data/processed/oregon_recognition_features_v04_temp.csv"
...
def merge_land_mask(grid: gpd.GeoDataFrame, land: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
    log("Merging Oregon land validity mask")
...
def compute_features(grid: gpd.GeoDataFrame, osm: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
    log("Computing expanded Oregon Recognition v04 feature counts")
...
def compute_group_scores(grid: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
    log("Computing Oregon Recognition v04 group scores")
...
def main():
    log("Starting Oregon Recognition Features v04")
    ...
    grid.to_file(
        OUT_GPKG,
        layer="oregon_recognition_features_v04",
        driver="GPKG",
    )
    ...
    print("\nOregon Recognition v04 summary:")
    summary_cols = [
    ...
    existing_summary_cols = [c for c in summary_cols if c in grid.columns]
    print(grid[existing_summary_cols].describe(include="all"))
