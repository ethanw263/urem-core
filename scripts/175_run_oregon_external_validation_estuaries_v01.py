...
SCRIPT_NAME = "175_run_oregon_external_validation_estuaries_v01"

HOTSPOTS = "data/processed/oregon_transition_hotspot_validation_summary_v01.gpkg"
ESTUARIES = "data/validation/standardized/estuaries_oregon_pmep_v01.gpkg"

OUTPUT_DIR = Path("data/validation/results")
OUTPUT_RESULTS_CSV = OUTPUT_DIR / "oregon_estuary_external_validation_results_v01.csv"
OUTPUT_SUMMARY_CSV = OUTPUT_DIR / "oregon_estuary_external_validation_summary_v01.csv"
OUTPUT_REPORT_MD = OUTPUT_DIR / "oregon_estuary_external_validation_report_v01.md"
...
def main():
    ...
    estuary_dataset = ValidationDataset(
        name="Estuaries",
        path=ESTUARIES,
    ...
    engine.register_dataset(estuary_dataset)
    ...
    write_markdown_report(
        ...
        title="Oregon Estuary External Validation Report v01",
    )
