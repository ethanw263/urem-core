...
def validation_metrics_for_prepared_layer(
    ...
    """
    Compute validation metrics against a prepared validation layer.

    This version intentionally avoids sindex.nearest because GeoPandas/Shapely
    versions differ in the shape of the returned object.
    """
